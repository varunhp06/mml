fetch('http://localhost:8080/tv/allShows/score/asc')
    .then(res => {
        return res.json();
    })
    .then(data => {
...
document.getElementById('ScoreButton').addEventListener("click", function(){
    window.location.href = '../allShowsByScoreDesc/allShowsByScoreDesc.html';
})
...
document.getElementById('Switch').addEventListener("click", function(){
    window.location.href = '../../../../movie/lists/allMoviesByScore/allMoviesByScoreAsc/allMoviesByScoreAsc.html';
})