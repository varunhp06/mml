fetch('http://localhost:8080/tv/allShows/startYear/desc')
    .then(res => {
        return res.json();
    })
    .then(data => {
...
document.getElementById('YearButton').addEventListener("click", function(){
    window.location.href = '../allShowsByStartYearAsc/allShowsByStartYearAsc.html';
})

document.getElementById('Switch').addEventListener("click", function(){
    window.location.href = '../../../../movie/lists/allMoviesByYear/allMoviesByYearDesc/allMoviesByYearDesc.html';
})