fetch('http://localhost:8080/tv/allShows/startYear/asc')
    .then(res => {
        return res.json();
    })
    .then(data => {
...
document.getElementById('YearButton').addEventListener("click", function(){
    window.location.href = '../allShowsByStartYearDesc/allShowsByStartYearDesc.html';
})

document.getElementById('Switch').addEventListener("click", function(){
    window.location.href = '../../../../movie/lists/allMoviesByYear/allMoviesByYearAsc/allMoviesByYearAsc.html';
})