...
document.getElementById('RankButton').addEventListener("click", function(){
    window.location.href = '../allShowsByRankAsc/allShowsByRankAsc.html';
})
...
document.getElementById('Switch').addEventListener("click", function(){
    window.location.href = '../../../../movie/lists/allMoviesByRank/allMoviesByRankDesc/allMoviesByRankDesc.html';
})