fetch('http://localhost:8080/movie/allMovies/year/asc')
    .then(res => {
        return res.json();
    })
    .then(data => {
...
document.getElementById('YearButton').addEventListener("click", function(){
    window.location.href = '../allMoviesByYearDesc/allMoviesByYearDesc.html';
})

document.getElementById('Switch').addEventListener("click", function(){
    window.location.href = '../../../../tv/lists/allShowsByStartYear/allShowsByStartYearAsc/allShowsByStartYearAsc.html';
})