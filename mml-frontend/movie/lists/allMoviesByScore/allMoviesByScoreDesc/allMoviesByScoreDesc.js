fetch('http://localhost:8080/movie/allMovies/score/desc')
    .then(res => {
        return res.json();
    })
    .then(data => {
...
document.getElementById('ScoreButton').addEventListener("click", function(){
    window.location.href = '../allMoviesByScoreAsc/allMoviesByScoreAsc.html';
})
...
document.getElementById('Switch').addEventListener("click", function(){
    window.location.href = '../../../../tv/lists/allShowsByScore/allShowsByScoreDesc/allShowsByScoreDesc.html';
})