fetch('http://localhost:8080/movie/allMovies/score/asc')
    .then(res => {
        return res.json();
    })
    .then(data => {
...
document.getElementById('ScoreButton').addEventListener("click", function(){
    window.location.href = '../allMoviesByScoreDesc/allMoviesByScoreDesc.html';
})
...
document.getElementById('Switch').addEventListener("click", function(){
    window.location.href = '../../../../tv/lists/allShowsByScore/allShowsByScoreAsc/allShowsByScoreAsc.html';
})